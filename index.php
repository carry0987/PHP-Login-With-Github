...
if (isset($accessToken)) {
    ...
    $output = '<a href="'.htmlspecialchars($loginURL).'"><img src="image/sign-in-with-github.svg" alt="sign-in-with-github" /></a>';
}
?>
...
<html>
    <head>
        <meta charset="UTF-8">
        <title>Login with GitHub using PHP by carry0987</title>
    </head>
    <body>
        <div class="container">
